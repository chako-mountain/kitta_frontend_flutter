...
class CutListServiceClient extends $grpc.Client {
  ...
  $grpc.ResponseFuture<$0.rescreateUser> createUser(
    $0.reqcreateUser request, {
  ...
  $grpc.ResponseFuture<$0.ResCreateCutList> createCutList(
    $0.ReqCreateCutList request, {
    $grpc.CallOptions? options,
  }) {
    return $createUnaryCall(_$createCutList, request, options: options);
  }

  // method descriptors

  static final _$createUser =
      $grpc.ClientMethod<$0.reqcreateUser, $0.rescreateUser>(
          '/tutorial.CutListService/CreateUser',
          ($0.reqcreateUser value) => value.writeToBuffer(),
          $0.rescreateUser.fromBuffer);
  ...
  static final _$createCutList =
      $grpc.ClientMethod<$0.ReqCreateCutList, $0.ResCreateCutList>(
          '/tutorial.CutListService/CreateCutList',
          ($0.ReqCreateCutList value) => value.writeToBuffer(),
          $0.ResCreateCutList.fromBuffer);
}
...
abstract class CutListServiceBase extends $grpc.Service {
  ...
  CutListServiceBase() {
    $addMethod($grpc.ServiceMethod<$0.reqcreateUser, $0.rescreateUser>(
        'CreateUser',
        createUser_Pre,
        false,
        false,
        ($core.List<$core.int> value) => $0.reqcreateUser.fromBuffer(value),
        ($0.rescreateUser value) => value.writeToBuffer()));
    ...
    $addMethod($grpc.ServiceMethod<$0.ReqCreateCutList, $0.ResCreateCutList>(
        'CreateCutList',
        createCutList_Pre,
        false,
        false,
        ($core.List<$core.int> value) => $0.ReqCreateCutList.fromBuffer(value),
        ($0.ResCreateCutList value) => value.writeToBuffer()));
  }

  $async.Future<$0.rescreateUser> createUser_Pre(
      $grpc.ServiceCall $call, $async.Future<$0.reqcreateUser> $request) async {
    return createUser($call, await $request);
  }

  $async.Future<$0.rescreateUser> createUser(
      $grpc.ServiceCall call, $0.reqcreateUser request);
  ...
  $async.Future<$0.ResCreateCutList> createCutList_Pre($grpc.ServiceCall $call,
      $async.Future<$0.ReqCreateCutList> $request) async {
    return createCutList($call, await $request);
  }

  $async.Future<$0.ResCreateCutList> createCutList(
      $grpc.ServiceCall call, $0.ReqCreateCutList request);
}
