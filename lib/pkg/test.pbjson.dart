...
@$core.Deprecated('Use reqcreateUserDescriptor instead')
const reqcreateUser$json = {
  '1': 'reqcreateUser',
  '2': [
...
/// Descriptor for `reqcreateUser`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List reqcreateUserDescriptor =
    $convert.base64Decode('Cg1yZXFjcmVhdGVVc2VyEhIKBHV1aWQYASABKAlSBHV1aWQ=');

@$core.Deprecated('Use rescreateUserDescriptor instead')
const rescreateUser$json = {
  '1': 'rescreateUser',
  '2': [
...
/// Descriptor for `rescreateUser`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List rescreateUserDescriptor =
    $convert.base64Decode('Cg1yZXNjcmVhdGVVc2VyEg4KAmlkGAEgASgDUgJpZA==');

@$core.Deprecated('Use reqCreateCutListDescriptor instead')
const ReqCreateCutList$json = {
  '1': 'ReqCreateCutList',
  '2': [
...
/// Descriptor for `ReqCreateCutList`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List reqCreateCutListDescriptor = $convert.base64Decode(
    'ChBSZXFDcmVhdGVDdXRMaXN0Eh4KC3RoaXNfaXNfY3V0GAEgASgIUgl0aGlzSXNDdXQSFwoHdX'
    'Nlcl9pZBgCIAEoA1IGdXNlcklkEhIKBG5hbWUYAyABKAlSBG5hbWUSFAoFY29sb3IYBCABKAlS'
    'BWNvbG9yEhQKBWNvdW50GAUgASgDUgVjb3VudBIUCgVsaW1pdBgGIAEoA1IFbGltaXQSGwoJbG'
    'F0ZV90aW1lGAcgASgDUghsYXRlVGltZRIdCgpsYXRlX2NvdW50GAggASgDUglsYXRlQ291bnQ=');

@$core.Deprecated('Use reqUpateCutListDescriptor instead')
const ReqUpateCutList$json = {
  '1': 'ReqUpateCutList',
  '2': [
    {'1': 'id', '3': 1, '4': 1, '5': 3, '10': 'id'},
    {'1': 'this_is_cut', '3': 2, '4': 1, '5': 8, '10': 'thisIsCut'},
    {'1': 'name', '3': 3, '4': 1, '5': 9, '10': 'name'},
    {'1': 'color', '3': 4, '4': 1, '5': 9, '10': 'color'},
    {'1': 'count', '3': 5, '4': 1, '5': 3, '10': 'count'},
    {'1': 'limit', '3': 6, '4': 1, '5': 3, '10': 'limit'},
...
/// Descriptor for `ReqUpateCutList`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List reqUpateCutListDescriptor = $convert.base64Decode(
    'Cg9SZXFVcGF0ZUN1dExpc3QSDgoCaWQYASABKANSAmlkEh4KC3RoaXNfaXNfY3V0GAIgASgIUg'
    'l0aGlzSXNDdXQSEgoEbmFtZRgDIAEoCVIEbmFtZRIUCgVjb2xvchgEIAEoCVIFY29sb3ISFAoF'
    'Y291bnQYBSABKANSBWNvdW50EhQKBWxpbWl0GAYgASgDUgVsaW1pdBIbCglsYXRlX3RpbWUYBy'
    'ABKANSCGxhdGVUaW1lEh0KCmxhdGVfY291bnQYCCABKANSCWxhdGVDb3VudA==');

@$core.Deprecated('Use resCreateCutListDescriptor instead')
const ResCreateCutList$json = {
  '1': 'ResCreateCutList',
  '2': [
    {'1': 'id', '3': 1, '4': 1, '5': 3, '10': 'id'},
  ],
...
/// Descriptor for `ResCreateCutList`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List resCreateCutListDescriptor =
    $convert.base64Decode('ChBSZXNDcmVhdGVDdXRMaXN0Eg4KAmlkGAEgASgDUgJpZA==');
...
const res_getCutList$json = {
  ...
  '2': [
    ...
    {'1': 'count', '3': 5, '4': 1, '5': 3, '10': 'count'},
    {'1': 'limit', '3': 6, '4': 1, '5': 3, '10': 'limit'},
    {'1': 'late_count', '3': 7, '4': 1, '5': 3, '10': 'lateCount'},
...
final $typed_data.Uint8List res_getCutListDescriptor = $convert.base64Decode(
    ...
    'b3VudBgFIAEoA1IFY291bnQSFAoFbGltaXQYBiABKANSBWxpbWl0Eh0KCmxhdGVfY291bnQYBy'
...
const req_getCutHistory$json = {
  '1': 'req_getCutHistory',
  '2': [
    {'1': 'list_id', '3': 1, '4': 1, '5': 3, '10': 'listId'},
  ],
};
...
final $typed_data.Uint8List req_getCutHistoryDescriptor = $convert.base64Decode(
    'ChFyZXFfZ2V0Q3V0SGlzdG9yeRIXCgdsaXN0X2lkGAEgASgDUgZsaXN0SWQ=');
...
const res_getCutHistory$json = {
  ...
  '2': [
    {'1': 'id', '3': 1, '4': 1, '5': 3, '10': 'id'},
    {'1': 'this_is_cut', '3': 2, '4': 1, '5': 8, '10': 'thisIsCut'},
    {'1': 'late_time', '3': 3, '4': 1, '5': 3, '10': 'lateTime'},
    {'1': 'lists_updated_at', '3': 4, '4': 1, '5': 9, '10': 'listsUpdatedAt'},
...
final $typed_data.Uint8List res_getCutHistoryDescriptor = $convert.base64Decode(
    'ChFyZXNfZ2V0Q3V0SGlzdG9yeRIOCgJpZBgBIAEoA1ICaWQSHgoLdGhpc19pc19jdXQYAiABKA'
    'hSCXRoaXNJc0N1dBIbCglsYXRlX3RpbWUYAyABKANSCGxhdGVUaW1lEigKEGxpc3RzX3VwZGF0'
    'ZWRfYXQYBCABKAlSDmxpc3RzVXBkYXRlZEF0Eh0KCnVwZGF0ZWRfYXQYBSABKAlSCXVwZGF0ZW'
    'RBdA==');
